...
public class CurrencyController {
    ...
    public ResponseEntity<CurrencyDTO> getConvert(
        ...
        // 1. Tenta buscar taxa de conversão no banco de dados local
        ...
        // 2. Não encontrado localmente — consulta API do Banco Central do Brasil (PTAX)
    ...
    /**
     * Fallback acionado pelo @CircuitBreaker quando a API do BCB está indisponível
     * e o FeignClient fallback (BCBClientFallback) também não consegue retornar dados.
     * Retorna taxa de conversão 1.0 para manter o serviço operacional.
     */
